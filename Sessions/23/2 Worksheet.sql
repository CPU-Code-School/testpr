/*
Modify VacationDB 
Create a new table to store info about attractions.
Table should include an Attraction Name (name column AttractionName to clearly distinguish from vacation place), amount of money spent, and foreign key to vacation.
Omit constraints 
Populate tables with enough rows of data to make CRUD interesting. 
...
--9) Delete all vacation places where the money spent is greater than $50.
